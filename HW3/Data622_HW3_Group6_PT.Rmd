...
Create folds for the tuning process and just create five folds for this process.
...
mod_boost <- boost_tree(trees = 25,
                        ...
                        min_n = tune(),
                        tree_depth = tune()) %>%
  set_engine("xgboost", lambda=0, alpha=1, num_class=3, verbose=0, stop_iter=2) %>%
...
#importance_matrix <- xgb.importance(model = best_boost)
