...
lap_data <- dplyr::select(lap_data, Credit_History, Income_To_LoanAmt, Property_Area, ApplicantIncome, Loan_Status)

summary(lap_data)

lap_data_split <- initial_split(lap_data, prop=0.7, strata=Loan_Status)
...
# Specify the model
mod_boost <- boost_tree(trees = 100, # 1000 at tune usage URL
                        learn_rate = tune(),
                        sample_size = tune(),
                        mtry = tune(),
                        min_n = tune(),
