...
```{r, warning=F}
our_data<-use_data[,colnames(use_data[(surfedModel$varselect.interp)])]
...
Our full model has an accuracy on the test data of 0.821 and a Kappa of 0.478  Unfortunately, this is less than our "Model" of a simple credit_history. 
