...
Since out CART algorithm uses sum of squares to select splits and since center and scaled data shouldn't effect the relationship between variables, I'm going to stick with the original currency values. 
...
Our accuracy is 80%. Below is our confusion matrix using the caret library.

```{r}
final_fit %>%
  collect_predictions() -> a

#a %>% conf_mat(Loan_Status, .pred_class) 

# Save the caret version of the confusion matrix
(cm_decision_tree = confusionMatrix(a$.pred_class, a$Loan_Status ) )
